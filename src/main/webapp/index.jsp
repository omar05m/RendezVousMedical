...
<body>
					...
					<div class="col-lg-3">
						<div class="social-links">
							<ul>
								...
								<li><a href="https://www.instagram.com/khaalil_ber"><i class="fa fa-instagram"></i></a></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-5">
					...
					<p>Earth greater grass for good. Place for divide evening
						yielding them that. Creeping beginning over gathered brought.</p>
					<a href="#appointment-form" class="template-btn mt-3"
						onclick="scrollToAppointment(event)">take appointment</a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row">
				<div class="col-lg-3 col-md-6">
					<div class="single-feature text-center item-padding">
						...
						<p class="pt-3">Creeping for female light years that lesser
							can't evening heaven isn't bearing tree appear</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6">
			...
			<div class="row">
				...
				<div class="col-lg-7">
					<div class="welcome-text mt-5 mt-lg-0">
						...
						<p class="pt-3">Subdue whales void god which living don't
							midst lesser yielding over lights whose. Cattle greater brought
							sixth fly den dry good tree isn't seed stars were.</p>
						<p>Subdue whales void god which living don't midst lesser
							yielding over lights whose. Cattle greater brought sixth fly den
							dry good tree isn't seed stars were the boring.</p>
				...
				<div class="col-lg-12">
					<div class="department-slider owl-carousel">
						<div class="single-slide">
							<div class="slide-img">
								<img src="assets/images/department1.jpg" alt=""
									class="img-fluid">
							...
							<div class="single-department item-padding text-center">
								...
								<p>Hath creeping subdue he fish gred face whose spirit that
									seasons today multiply female midst upon</p>
							</div>
						</div>
						<div class="single-slide">
							<div class="slide-img">
								<img src="assets/images/department2.jpg" alt=""
									class="img-fluid">
								<div class="hover-state">
	...
	<!-- Patient Area Starts -->
	<section
		class="patient-area section-padding appointment-area section-padding"
		id="appointment-form">
		<div class="container">
			<div class="row">
				<div class="col-lg-6 offset-lg-3">
			...
			<div class="row">
				<div class="col-lg-5">
					<div class="single-patient mb-4">
						...
						<h3>daren jhonson</h3>
						<h5>hp specialist</h5>
						<p class="pt-3">Elementum libero hac leo integer. Risus hac
							road parturient feugiat. Litora cursus hendrerit bib elit Tempus
							inceptos posuere metus.</p>
					</div>
						...
						<form action="#">
							...
							<div class="mt-10">
								<input type="date" name="date" placeholder="Appointment Date"
									onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Appointment Date'" required
									class="single-input">
							</div>
							<div class="mt-10">
								<textarea class="single-textarea" name="message"
									placeholder="Message" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Message'" required></textarea>
							</div>
							<button type="submit" class="template-btn mt-10">Book
								Now</button>
						</form>
					</div>
				</div>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<p class="pt-3">
						We provide 24/7 customer support. Please feel free to contact us <br>for
						emergency case.
					</p>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-6">
					<div class="single-news">
						...
						<div class="news-text">
							<div class="news-date">22 July 2018</div>
							<h3>
								<a href="blog-details.html">chip to model coeliac disease</a>
							</h3>
							<p>Elementum libero hac leo integer. Risus hac part duriw
								feugiat litora cursus hendrerit bibendum per person on
								elit.Tempus inceptos posuere me.</p>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-6">
					<div class="single-news mt-5 mt-md-0">
						...
						<div class="news-text">
							<div class="news-date">22 Oct 2018</div>
							<h3>
								<a href="blog-details.html">Galectins An Ancient FaSi Future</a>
							</h3>
							<p>Elementum libero hac leo integer. Risus hac part duriw
								feugiat litora cursus hendrerit bibendum per person on
								elit.Tempus inceptos posuere me.</p>
				...
				<div class="col-lg-4 col-md-6">
					<div class="single-news mt-5 mt-lg-0">
						...
						<div class="news-text">
							<div class="news-date">22 Sep 2018</div>
							<h3>
								<a href="blog-details.html">Getting the Most Out of the
									CLARI</a>
							</h3>
							<p>Elementum libero hac leo integer. Risus hac part duriw
								feugiat litora cursus hendrerit bibendum per person on
